...
public class HTMLGui extends GuiScreen {
   ...
   public HTMLGui(UltralightRenderer renderer, String filePath, int width, int height) throws JavascriptEvaluationException {
      ...
      JavaScriptBridge bridge = new JavaScriptBridge(viewController.getView());
      bridge.setContext(bridge,"SkyCodingBridge",viewController.getView().lockJavascriptContext().getContext());
